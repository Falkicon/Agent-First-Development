...
import { todoAdapter, createTodoAdapter, type TodoFixture } from './todo.js';
import type { AppAdapter, AdapterContext, ApplyFixtureResult } from './types.js';
  ...
  describe('fixture.apply', () => {
    it('applies generic data fixture', async () => {
      ...
      const fixture = {
        app: 'test',
        data: [
          { command: 'cmd.one', input: { key: 'value' } },
          { command: 'cmd.two' },
        ],
      };
