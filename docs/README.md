...
- [Auth Adapter](./features/complete/auth-adapter/) — Authentication adapter pattern for AFD servers
...
- `optimistic-mutations` skill — Optimistic mutation patterns for interactive AFD clients
